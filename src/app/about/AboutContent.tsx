  ...
  return (
    <main style={{ background: "#050505", minHeight: "100vh", color: "white" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "absolute", top: "-10%", left: "50%", transform: "translateX(-50%)", width: "min(800px, 100%)", height: "600px", background: "radial-gradient(circle, rgba(255,106,0,0.08) 0%, transparent 70%)", pointerEvents: "none" }} />
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            <h1 style={{
              ...
              Beyond tracking.<br />
              <span style={{ color: "#FF6A00" }}>Intelligent systems.</span>
            </h1>
            <p style={{
      ...
      <section style={{ padding: "clamp(40px, 6vw, 80px) 0", background: "rgba(255,106,0,0.02)", borderTop: "1px solid rgba(255,106,0,0.1)", borderBottom: "1px solid rgba(255,106,0,0.1)" }}>
        <div className="container" style={{ maxWidth: "900px" }}>
          <h2 style={{ fontSize: "12px", fontWeight: "800", color: "#FF6A00", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "24px", textAlign: "center" }}>
            Who We Are
          </h2>
          <p style={{ fontSize: "16px", color: "rgba(255,255,255,0.65)", lineHeight: "1.8", textAlign: "center", marginBottom: "40px" }}>
            The Fitnivo editorial team is made up of fitness enthusiasts, certified nutrition advisors, and mobile product specialists who have personally used and tested every app we review. We hold ourselves to a simple standard: we only recommend what we would genuinely use ourselves.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "20px" }}>
            {[
              { title: "Testing Methodology", desc: "Every app is used for a minimum of 14 days before being reviewed. We track AI adaptability, UX quality, and pricing transparency." },
              { title: "Conflict of Interest", desc: "Fitnivo is our own product. We disclose this on every page that compares it to competitors — and we call out where others are the better pick." },
              { title: "Update Policy", desc: "Reviews are refreshed when apps release major updates or pricing changes. Check the dateModified at the top of each article." },
            ].map((item) => (
              <div key={item.title} style={{ padding: "24px", background: "rgba(255,255,255,0.02)", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.06)" }}>
                <h3 style={{ fontWeight: "700", marginBottom: "10px", fontSize: "15px", color: "#FF6A00" }}>{item.title}</h3>
                <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.5)", lineHeight: "1.7" }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container">
          <div className="stack-on-mobile" style={{ gap: "clamp(40px, 8vw, 100px)", alignItems: "center" }}>
            <motion.div
              ...
              style={{ flex: 1 }}
            >
              <h2 style={{ fontSize: "12px", fontWeight: "800", color: "#FF6A00", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "24px" }}>
                Our Belief
              </h2>
              <p style={{ fontSize: "clamp(24px, 5vw, 32px)", fontWeight: "700", lineHeight: "1.3", marginBottom: "32px", letterSpacing: "-0.02em" }}>
                Real transformation happens when fitness, nutrition, and mental clarity <span style={{ color: "#FF6A00" }}>work together.</span>
              </p>
            ...
            >
              <div style={{
                ...
                <Image
                  ...
                  alt="Fitnivo team testing AI fitness apps for elite performance"
                  width={600}
                  height={600}
      ...
      <section style={{ padding: "clamp(60px, 8vw, 100px) 0", background: "rgba(255,255,255,0.01)" }}>
        <div className="container">
          <h2 style={{ textAlign: "center", fontSize: "12px", fontWeight: "800", color: "#FF6A00", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "clamp(40px, 8vw, 100px)" }}>
            ...
            <div className="stack-on-mobile" style={{ gap: "clamp(40px, 8vw, 80px)", alignItems: "center" }}>
              <div style={{ flex: 1, height: "400px", borderRadius: "32px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.05)", width: "100%" }}>
                <Image
                  ...
                  alt="Fitnivo AI adaptive intelligence system core"
                  width={600}
                  height={400}
                  style={{ width: "100%", height: "100%", objectFit: "cover" }}
                />
              ...
              <div style={{ flex: 1 }}>
                <h3 style={{ fontSize: "20px", fontWeight: "800", color: "#FF6A00", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "24px" }}>Our Systems</h3>
          ...
          <div className="stack-on-mobile" style={{ gap: "clamp(40px, 8vw, 80px)", alignItems: "center" }}>
            <div style={{
              ...
              <Image
                ...
                alt="Fitnivo mindfulness and mental fitness approach"
                width={600}
                height={600}
                style={{ width: "100%", height: "100%", objectFit: "cover" }}
              />
      ...
      <section style={{ paddingBottom: "clamp(100px, 15vw, 200px)" }}>
        <div className="container" style={{ maxWidth: "900px", textAlign: "center" }}>
          ...
          >
            <h2 style={{ fontSize: "12px", fontWeight: "800", color: "#FF6A00", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "32px" }}>
              Our Vision
            </h2>
            ...
            <div style={{ height: "1px", width: "80px", background: "#FF6A00", margin: "0 auto 48px auto" }} />
            <p style={{ fontSize: "clamp(18px, 3vw, 24px)", color: "#FF6A00", fontWeight: "800" }}>
